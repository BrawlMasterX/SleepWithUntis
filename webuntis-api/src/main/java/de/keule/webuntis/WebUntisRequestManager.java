...
public class WebUntisRequestManager {
  ...
  public static WebUntisResponse requestPOST(WebUntisRequestMethod method, WebUntisSessionInfo session,
      String endPoint, String school, String params) throws IOException, JSONException {
  ...
  public static WebUntisResponse requestPOST(String method, WebUntisSessionInfo session, String endPoint,
      String school, String params) throws IOException, JSONException {
    final URL url;
    try {
  ...
  public static WebUntisResponse requestGET(WebUntisSessionInfo session, String endPoint) throws IOException, JSONException {
    final URL url;
    try {
