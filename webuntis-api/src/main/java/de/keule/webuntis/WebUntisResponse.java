...
public class WebUntisResponse {
	...
	public boolean hasAcces() throws JSONException {
	...
	public String getCompleteErrorMessage() throws JSONException {
		JSONObject error = response.optJSONObject("error");
		if (error == null)
			return "No Error";
	...
	public static int getErrorCode(JSONObject json) throws JSONException {
		if (!hasError(json))
			return 0;
