...
public class WebUntis {
	...
	private boolean normalLogin() throws IOException, JSONException {
	...
	private boolean anonymousLogin() throws IOException, JSONException {
	...
	private boolean secretLogin(boolean getUserInfo) throws IOException, JSONException {
		JSONArray params = new JSONArray();
	...
	/* Get timetable */
	public Timetable getTimetableForToday() throws IOException, JSONException {
		return getTimetable(session.getType(), session.getPersonId(), null, null);
	}

	public Timetable getTimetableForToday(Klasse klasse) throws IOException, JSONException {
		return getTimetable(1, klasse.getId(), null, null);
	}

	public Timetable getTimetableForToday(int type, int id) throws IOException, JSONException {
		return getTimetable(type, id, null, null);
	}

	public Timetable getTimetableForWeek() throws IOException, JSONException {
	...
	public Timetable getTimetableForWeek(Klasse klasse) throws IOException, JSONException {
		final int startDate = WebUntisDateOperations.getStartDateFromWeek(Calendar.getInstance(), 0);
		return getTimetable(1, klasse.getId(), startDate,
				WebUntisDateOperations.addDaysToDate(startDate, 6));
	}
	
	public Timetable getTimetableForWeek(int type, int id) throws IOException, JSONException {
		final int startDate = WebUntisDateOperations.getStartDateFromWeek(Calendar.getInstance(), 0);
		return getTimetable(type, id, startDate, WebUntisDateOperations.addDaysToDate(startDate, 6));
	}

	public Timetable getTimetableForRange(int startDate, int endDate) throws IOException, JSONException {
		return getTimetable(session.getType(), session.getPersonId(), startDate, endDate);
	}
	
	public Timetable getTimetableForRange(int startDate, int endDate, Klasse klasse) throws IOException, JSONException {
		return getTimetable(1, klasse.getId(), startDate, endDate);
	}

	public Timetable getTimetableForRange(int startDate, int endDate, int type, int id) throws IOException, JSONException {
		return getTimetable(type, id, startDate, endDate);
	}

	public Timetable getTimetableFor(int date) throws IOException, JSONException {
		return getTimetable(session.getType(), session.getPersonId(), date, date);
	}

	public Timetable getTimetableFor(int date, int type, int id) throws IOException, JSONException {
		return getTimetable(type, id, date, date);
	}

	private Timetable getTimetable(int type, int elementId, Integer startDate, Integer endDate) throws IOException, JSONException {
		if (!sessionIsValid())
	...
	/* Get teachers */
	public Teachers getTeachers() throws IOException, JSONException {
	...
	/* Get students */
	public Students getStudents() throws IOException, JSONException {
	...
	/* Get klassen */
	public Klassen getKlassen() throws IOException, JSONException {
		return getKlassen(null);
	}

	public Klassen getKlassen(String schoolYearId) throws IOException, JSONException {
		JSONObject params = new JSONObject();
	...
	/* Get subjects */
	public Subjects getSubjects() throws IOException, JSONException {
	...
	/* Get rooms */
	public Rooms getRooms() throws IOException, JSONException {
	...
	/* Get departments */
	public Departments getDepartments() throws IOException, JSONException {
	...
	/* Get holidays */
	public Holidays getHolidays() throws IOException, JSONException {
	...
	/* Get timegrid */
	public Timegrid getTimegrid(LocalDate date) throws IOException, JSONException {
	...
	/* Get status data */
	public StatusData getStatusData() throws IOException, JSONException {
	...
	public Schoolyear getCurrentSchoolyear() throws IOException, JSONException {
	...
	/* Get schoolyears */
	public Schoolyears getSchoolyears() throws IOException, JSONException {
	...
	public long getLastImportTime() throws IOException, JSONException {
	...
	/* Search personId */
	public int getPersonId(int type, String surename, String forename, int dateOfBirth) throws JSONException {
		JSONObject params = new JSONObject();
	...
	/* Get substitutions */
	public Substitutions getSubstitutions(int startDate, int endDate, int departmentId) throws IOException, JSONException {
		JSONObject params = new JSONObject();
	...
	/* Get classreg events */
	public ClassregEvents getClassregEvents(int startDate, int endDate) throws IOException, JSONException {
		return getClassregEvents(startDate, endDate, null, null, null);
	}

	/* Get classreg events for a given student or klasse */
	public ClassregEvents getClassregEvents(int startDate, int endDate, int type, int id) throws IOException, JSONException {
	...
	/* Get exams */
	public Exams getExams(int examTypeId, int startDate, int endDate) throws IOException, JSONException {
		JSONObject params = new JSONObject();
		params.put("startDate", startDate);
		params.put("endDate", endDate);
	...
	/* Get exams types */
	public JSONObject getExamTypes() throws IOException, JSONException {
	...
	public Absences getTimetableWithAbsences(int startDate, int endDate) throws IOException, JSONException {
		JSONObject options = new JSONObject();
		options.put("startDate", startDate);
		options.put("endDate", endDate);
		JSONObject params = new JSONObject();
	...
	public RemarkCategories getClassregCategories() throws IOException, JSONException {
	...
	public RemarkGroups getClassregCategoryGroups() throws IOException, JSONException {
	...
	/* Static */
	public static Schools searchSchool(String name) throws WebUntisException, JSONException {
		return searchSchool(name, "ID");
	}

	public static Schools searchSchool(String name, String id) throws WebUntisException, JSONException {
		JSONArray params = new JSONArray();
